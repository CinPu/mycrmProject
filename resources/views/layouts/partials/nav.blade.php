...
{{--						</li>--}}
						...
						@php
                           ...
                           foreach ($all_auth_emp as $auth_emp){
                               if($auth_emp->user->hasAnyRole("TicketAdmin") && $auth_emp->employee->admin_id==\Illuminate\Support\Facades\Auth::user()->id){
				...
				@elseif(\Illuminate\Support\Facades\Auth::user()->hasAnyRole("TicketAdmin"))
					<ul>
						...
						<li class="{{ Request::is('home') ? 'active' : '' }}" >
							<a href="{{ url('/home') }}"><i class="la la-dashboard mr-2"></i><span>Dashboard</span></a>
						</li>
						<li class="{{ Request::is('agent') ? 'active' : '' }}" >
							<a href="{{ url('/agent') }}"><i class="la la-users mr-2"></i><span>Agent</span></a>
						</li>
						<li class="{{ Request::is('priority') ? 'active' : '' }}">
							<a href="{{ url('priority') }}"><i class="la la-signal"></i><span>Priority</span></a></li>
						<li class="{{ Request::is('case_type') ? 'active' : '' }}">
							<a  href="{{ url('/case_type') }}"><i class="la la-th-list"></i><span>Case Type</span></a></li>
						<li class="{{ Request::is('piechart') ? 'active' : '' }}">
							<a  href="{{ url('/piechart') }}"><i class="la la-pie-chart"></i><span>Chart Report</span></a></li>
				...
				@elseif(\Illuminate\Support\Facades\Auth::user()->hasAnyRole("Agent"))
					<ul>
						...
						<li><a  href="{{ url('/agent/ticket') }}"><i class="fa fa-ticket"></i><span>Ticket</span></a></li>
					</ul>
