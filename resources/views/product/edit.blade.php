            ...
            <form action="{{url("product/update/$product->id")}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 col-6 " id="tax_div">
                        ...
                        <select name="tax" id="product_tax" class="form-control">
                            ...
                            @foreach($taxes as $tax)
                                @if($tax->id == $product->taxes->id)
                                    <option value="{{$product->taxes->id}}" selected >{{$product->taxes->name}}({{$product->taxes->rate}}%)</option>
                                @else
                    ...
                    <div class="form-group col-md-4 col-6">
                        ...
                        <img id="output" class="rounded offset-md-5 offset-4 mt-3" src="{{url(asset("/product_picture/$product->image"))}}" width="100px" height="100px;"><br>
                    </div>
